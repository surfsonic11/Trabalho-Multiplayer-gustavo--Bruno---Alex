...
public class GameManager : NetworkBehaviour
{
    ...
    //        {
    //            case 0:
    //                playerQ[0].SPR.material.color = Color.green;
    //                break;
    //            case 1:
    //                playerQ[1].SPR.material.color = Color.yellow;
    //                break;
    //            case 2:
    //                playerQ[2].SPR.material.color = Color.cyan;
    //                break;
    //            case 3:
    //                playerQ[3].SPR.material.color = Color.red;
    //                break;
